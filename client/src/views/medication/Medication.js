...
const Medication = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (!form.checkValidity()) {
        ...
        if (selectedItemId) {
          // Update operation
          await updateData(medication, selectedItemId)
        } else {
          // Add operation
          await addData(medication)
          setFormData({
            ...formData,
            medication: '',
          })
  ...
  const updateData = async (medication, id) => {
    const response = await axios.put(ip + 'medication', {
  ...
  const addData = async (medication) => {
    const response = await axios.post(ip + 'medication', { medication: medication })
  ...
  const deleteData = async (id) => {
    const response = await axios.delete(ip + 'medication', { data: { id: id } })
